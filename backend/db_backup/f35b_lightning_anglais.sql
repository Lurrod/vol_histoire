...
INSERT INTO airplanes (
    ...
    'F-35B Lightning II Anglais', 'Lockheed Martin F-35B Lightning II (Royal Air Force / Royal Navy)', 'Avion furtif STOVL de 5e génération au service du Royaume-Uni', 
    ...
    (SELECT id FROM countries WHERE code = 'GBR'), '1996-01-01', '2008-06-11', '2018-01-10', 
    1975.0, 1670.0, (SELECT id FROM manufacturer WHERE code = 'LM'), 
