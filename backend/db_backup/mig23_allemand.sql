...
INSERT INTO airplanes (
    ...
    'MiG-23 Allemand', 'Mikoyan-Gourevitch MiG-23MF/BN Flogger (NVA / Luftwaffe)', 'Chasseur multirôle soviétique de 3e génération à géométrie variable au service de l''Allemagne de l''Est', 
    ...
    (SELECT id FROM countries WHERE code = 'DEU'), '1964-01-01', '1967-06-10', '1978-06-01', 
