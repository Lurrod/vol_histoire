...
- Name: settings-profile.spec.js >> Settings — Profil & Sécurité >> modifier le nom et sauvegarder affiche un toast de succès
- Location: tests\settings-profile.spec.js:29:3
