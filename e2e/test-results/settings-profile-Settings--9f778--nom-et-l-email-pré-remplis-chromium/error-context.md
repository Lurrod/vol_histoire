...
- Name: settings-profile.spec.js >> Settings — Profil & Sécurité >> la page settings affiche le nom et l'email pré-remplis
- Location: tests\settings-profile.spec.js:11:3
