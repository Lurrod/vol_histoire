...
- Name: settings-profile.spec.js >> Settings — Profil & Sécurité >> la zone de danger affiche le bouton supprimer le compte
- Location: tests\settings-profile.spec.js:127:3
